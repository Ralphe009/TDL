...
<footer class="{outOfDate ? '' : 'invisible'}" bind:this={elNeedUpdate}>
	...
	<span class="copyright">&copy; 2021 - {year} <a href="https://github.com/Ralphe009/TDL">League Page</a></span>
	<br />
	<!-- PLEASE DO NOT REMOVE THE BUILT BY -->
	<span class="creator">Built by <a href="http://www.ebersondesigns.com">Ralph Abraham</a><br /></span>
